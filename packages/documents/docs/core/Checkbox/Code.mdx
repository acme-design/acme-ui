...
<Playground>
  <div>
    ...
    <Checkbox.Group layout="horizontal">
      <Checkbox value="a" style={{ marginRight: '30px' }}>
        选项A
      </Checkbox>
      <Checkbox value="b" style={{ marginRight: '30px' }}>
        选项B
      </Checkbox>
    ...
    <Checkbox.Group layout="vertical">
      <Checkbox value="a" style={{ marginBottom: '10px' }}>
        选项A
      </Checkbox>
      <Checkbox value="b" style={{ marginBottom: '10px' }}>
        选项B
      </Checkbox>
      <Checkbox value="c">选项C</Checkbox>
    </Checkbox.Group>
  ...
  {() => {
    ...
    return (
      <div>
        <Checkbox
          style={{ margin: '10px 0' }}
          indeterminate={horizontalIndeterminate}
          checked={horizontalCheckedAll}
          onChange={horizontalAllChange}
        >
          全选
        </Checkbox>
        <Checkbox.Group
          values={horizontalValues}
          onChange={horizontalGroupChange}
          layout="horizontal"
          style={{ marginLeft: '20px' }}
        >
          {options.map((item) => (
            <Checkbox key={item} value={item} style={{ marginRight: '30px' }}>
              选项{item}
            </Checkbox>
          ))}
        </Checkbox.Group>
...
<Playground>
  <FormGroup layout="horizontal">
    <Checkbox disabled style={{ marginRight: '30px' }}>
      备选A
    </Checkbox>
    <Checkbox disabled checked style={{ marginRight: '30px' }}>
      备选B
    </Checkbox>
